...
$_SESSION['typeofaccnt']='b';
?>
<!DOCTYPE html>
<html> 
<head>
	<title>beta pre-launch sign up</title>
...
<body>
<div style="padding:30px 20px 20px 20px;border:1px solid #00aeed;width:auto;max-width:420px;" id="betapermission">
	<div style="height:auto;">
		<div class="alpha_p1">
			...
			<ul class="bullet">
				<li>I will get 12 months subscription of Tabluu’s Enterprise plan (worth $718.80) at
only $8.80! I will get <u>$710 for FREE!</u></li>
