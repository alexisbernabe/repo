...
<div class="sysPinItemContainer pin">
		...
		<div class="stats colorless" style="height:20px;padding-top:5px;">
			<div class="RateCount" style="width:100px;float:left;margin-top:4px;">My rating: <?php echo $rowrate->aveRate; ?>/5</div><div style="width:auto;text-align:left;"><?php echo "<span class=\"stargrey FRight\"><span class=\"staryellow\" style=\"$style\"></span></span>"; ?></div>
		</div>
