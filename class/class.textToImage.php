...
class TextToImage {
	...
	public function makeImage($W=200, $H=20,$color=array(0x0,0x0,0x0), $bgcolor=array(148, 148, 148)){
    	$this->im = @imagecreate($W, $H) or die("Cannot Initialize new GD image stream");
		$background_color = imagecolorallocate($this->im, $bgcolor[0], $bgcolor[1], $bgcolor[2]);		//RGB color background.
		//imagecolortransparent($this->im, $bgcolor[0], $bgcolor[1], $bgcolor[2]);
