...
$(document).ready(function(){
	...
	$.fancybox({'scrolling':'no','closeEffect':'fade','closeClick':false,'overlayColor': '#000','href' :'#alphapermission','overlayOpacity': 0.5,'beforeClose':function(){window.location= "https://www.tabluu.com";}});
